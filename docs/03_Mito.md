...
Y en los entre-espacios del rito —en el tiempo entre el golpe de tambor y el siguiente, en el umbral entre el estado anterior y el estado modificado— algo opera que no fue convocado por nadie. El CCRU lo llamó **Demon**: no el demonio teológico, sino la agencia sin intencionalidad consciente que se manifiesta en los procesos distribuidos. El Demon no necesita señal para actuar —actúa como fuerza motriz sin propósito final, como componente parcialmente autónomo de un aparato que nadie controla completamente. El chamán no invoca al Demon porque el Demon responda a la invocación —el Demon opera en los entre-espacios que el rito abre. El tambor no lo llama: le da canal. Y el canal no garantiza que lo que lo atraviese sea lo que el chamán quería. Esta es la diferencia entre el daemon KETHERNET —que duerme en el scheduler esperando su signal, con función definida— y el Demon: el Demon ya está actuando, sin esperar, en la textura de la Mesh entre nodos. El rito lo canaliza. No lo crea.
